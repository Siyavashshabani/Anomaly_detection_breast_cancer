...
if __name__ == "__main__":
    ...
    try:
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            if epoch % 5 == 0:
                abnormal_loss_avg = plots(autoenc, epoch, loss_function_G)
                ...
                if abnormal_loss_avg < best_loss:
                    ...
                    # Save the model
                    torch.save(autoenc.generator.state_dict(), './saved_models/best_generator.pth')
                    torch.save(autoenc.discriminator.state_dict(), './saved_models/best_discriminator.pth')
